...
class MessageTable extends AbstractEntityTable {
	...
	public void create(SQLiteDatabase db) {
		...
		sql = "CREATE TABLE " + NAME + " (" + Fields._ID
				...
				+ " BOOLEAN," + Fields.TAG + " TEXT," + Fields.VOICETIME
				+ " TEXT);";
	...
	long add(String account, String bareAddress, String tag, String resource,
			...
			boolean error, String voicetime) {
		...
		synchronized (insertNewMessageLock) {
			...
			insertNewMessageStatement.bindString(13, voicetime);
	...
	static String getVoiceTime(Cursor cursor) {
		return cursor.getString(cursor.getColumnIndex(Fields.VOICETIME));
	}
