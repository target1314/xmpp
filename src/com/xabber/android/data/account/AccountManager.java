...
import com.xabber.android.ui.widget.ConnectManger;
import com.xabber.android.utils.FormatTools;
...
public class AccountManager implements OnLoadListener, OnWipeListener {
	...
	public static String regist(String account, String password,
		...
		if (ConnectManger.getConnection() == null)
			return "0";
		Registration reg = new Registration();
		reg.setType(IQ.Type.SET);
		reg.setTo(ConnectManger.getConnection().getServiceName());
		...
		PacketCollector collector = ConnectManger.getConnection()
				.createPacketCollector(filter);
		ConnectManger.getConnection().sendPacket(reg);
	 ...
	 * @return
	 */
	public static boolean changeImage(XMPPConnection connection, File file) {
		if (connection == null)
			return false;
		try {
