...
public class ContactAdd extends GroupListActivity implements
	...
	public void onClick(View view) {
		...
		case R.id.ok:
			...
			String user = userView.getText().toString() + Constant.serviceName;
			String nickName = nameView.getText().toString().trim();
			if (Constant.serviceName.equals(user)) {
				Toast.makeText(this, getString(R.string.EMPTY_USER_NAME),
						Toast.LENGTH_LONG).show();
				return;
			}
			if ("".equals(nickName)) {
				Toast.makeText(this, getString(R.string.NICKNAME),
						Toast.LENGTH_LONG).show();
				return;
			}
