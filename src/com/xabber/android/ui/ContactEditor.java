...
public class ContactEditor extends GroupListActivity implements
	...
	protected void onInflate(Bundle savedInstanceState) {
		...
		chat_pop.setVisibility(View.GONE);
	...
	private void update() {
		...
		String user_top = new String(user);
		String[] str_user = user_top.split("@");
		((TextView) findViewById(R.id.status_text)).setText(str_user[0]);
	}
