...
public abstract class GroupedContactAdapter<Inflater extends BaseContactInflater, StateProvider extends GroupStateProvider>
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (getItemViewType(position) == TYPE_CONTACT) {
			...
			String[] u_name = str.split("@");
			viewHolder.name.setText(u_name[0]);
			viewHolder.name_num.setText(" (" + configuration.getOnline() + "/"
	...
	private static class GroupViewHolder {
		...
		final TextView name;
		final TextView name_num;

		public GroupViewHolder(View view) {
			indicator = (ImageView) view.findViewById(R.id.indicator);
			name = (TextView) view.findViewById(R.id.name);
			name_num = (TextView) view.findViewById(R.id.name_num);
		}
	}
